...
- After a crash or lost live handles, the leader reruns review/QA lanes and joins with replacement evidence when metadata hashes still match; otherwise quarantine and re-baseline. Hoje Goals must not auto-start G(N+2) during recovery.
